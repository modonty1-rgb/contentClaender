    ...
    <Dialog>
      ...
      <DialogContent dir="rtl" className="max-h-[85vh] overflow-y-auto sm:max-w-2xl">
        ...
        <div className="space-y-4 text-sm">
          ...
          {entry.publishingTime ? <Row label="وقت النشر" value={entry.publishingTime} /> : null}
          {entry.reelLink ? (
            <Row
              label="رابط الريل"
          ...
          {entry.material ? <Row label="Material" value={entry.material} /> : null}
          {entry.size ? <Row label="المقاس" value={entry.size} /> : null}
          {entry.code ? <Row label="الكود" value={entry.code} /> : null}
          {entry.contentLink ? (
            <Row
              label="رابط المحتوى"
          ...
          {entry.readyToPublish ? <Row label="جاهز للنشر؟" value={entry.readyToPublish} /> : null}
          {entry.reviewed ? <Row label="تمت المراجعة؟" value={entry.reviewed} /> : null}
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {/* Add button */}
          <Link href={`/clients/${slug}/calendar/${month}/new`}>
                    ...
                    >
                      ...
                      <TableCell className="p-2">
                        <div className="flex items-center gap-0.5">
                          ...
                          <Button asChild size="sm" variant="ghost" className="h-7 px-2 text-xs gap-1 text-muted-foreground hover:text-foreground hover:bg-muted">
